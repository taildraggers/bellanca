"""Scrape Bellanca listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Bellanca Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    (
        "Trade-A-Plane",
        "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=bellanca&s-original-search=bellanca",
    ),
    ("Controller", "https://www.controller.com/listings?keywords=bellanca"),
    ("ASO", "https://aso.com/search?q=Bellanca"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Bellanca Listings</h2>
    <p>View additional Bellanca Aircraft listings at these fine sites:</p>
